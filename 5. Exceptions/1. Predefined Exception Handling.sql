...
/*
Eg:
The compiler cannot know that you will divide a number with a zero value.
To handle runtime errors, we need to handle it - that's why we need exceptions sections.
*/
