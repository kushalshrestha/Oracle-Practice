...
- Can be created in 3 different ways:
    1. creating a record + using cursor on that record type
    2. creating a rowtype of the same table type on which we are going to play with cursor
    3. records with cursor (best and easy way ) 
*/
