...
/*
Preferred way: FOR..IN with select example - if you do not have to perform select multiple time
*/


/* buffer flow exception example - b/c (n-1) rows prints 1 times but the last prints infinitely. Solution: handle with %NOTFOUND */
declare
